...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class MainPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            Preference myPref2 = findPreference(getString(R.string.support));
            myPref2.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
                    openMail(getActivity());
                    return true;
                }
            });
        }
    ...
    private static void openMail(Context c) {
        Intent mail = new Intent(Intent.ACTION_SEND);
        mail.setType("message/rfc822");
        mail.putExtra(Intent.EXTRA_EMAIL,"angana.sen12@gmail.com");
        c.startActivity(Intent.createChooser(mail,"Send Mail using"));
    }
}
