...
//                            Toast.makeText(SignInActivity.this, "Authentication Failed.", Toast.LENGTH_SHORT).show();
    ...
    private void updateUI(FirebaseUser user) {
        if(user != null) {
            Snackbar.make(findViewById(R.id.holder),"Signed in as "+user.getEmail(), Snackbar.LENGTH_LONG).show();
            Globals.email = user.getEmail();
            Globals.mAuth = mAuth;
            Globals.mGoogleSignInClient = mGoogleSignInClient;
            Globals.photoUrl = user.getPhotoUrl();
            Globals.displayName = user.getDisplayName();
