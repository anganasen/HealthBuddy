...
public class GetDataOld extends AsyncTask<String,String,String> {
    ProgressBar pd;
    Context c;
    ...
    public GetDataOld(ProgressBar pd, Context c, LinearLayout linearLayout, ScrollView scrollView, ImageView button, String message) {
        this.pd = pd;
        this.c = c;
